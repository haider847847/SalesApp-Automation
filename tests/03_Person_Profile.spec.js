const { test, expect } = require('../fixtures/personprofiles.fixtures')
...
test.describe('TEST 01 - Person Profile', () => {
  ...
  test('Search Person Profile', async ({ profileSearchPage: page }) => {
        await expect(
...
test.describe('TEST 02 - Person Profile', () => {
  ...
  test('Open Searched Person Profile', async ({ openedProfilePage: page }) => {
    await expect(
...
test.describe('TEST 03 - Person Profile', () => {
  ...
  test('Verify All Tabs on Person Profile', async ({ openedProfilePage: page }) => {
...
test.describe('TEST 04 - Person Profile', () => {
  ...
  test('Download Person Profile', async ({ openedProfilePage: page }) => {
...
test.describe('TEST 05 - Person Profile', () => {
  ...
  test('Share Person Profile', async ({ openedProfilePage: page }) => {
